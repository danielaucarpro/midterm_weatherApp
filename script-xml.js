...
function getWeather(cityName) {
    ...
    if (cityName) {
        ...
        //onreadystatechange return the loading status of current document. Detects any state changes.
        ...
        weatherHTTP.open('GET', 'https//api.openweathermap.org/data/2.5/weather?q=' + cityName + '&units=metric&appid=af2e529daf727ec2cbec62e2e2a2484b')
        weatherHTTP.send();
    }
